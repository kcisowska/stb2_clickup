...
class UpdateSpaceTest {
    ...
    private void updateSpaceStep() {
        JSONObject spaceUpdate = new JSONObject();
        spaceUpdate.put("name", SPACE_NAME_UPDATE);

        final var responseUpdate = UpdateSpaceRequest.updateSpace(spaceUpdate, spaceId);
